...
public class SchoolSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SchoolPackage.SCHOOL_STATISTICS: {
				SchoolStatistics schoolStatistics = (SchoolStatistics)theEObject;
				T result = caseSchoolStatistics(schoolStatistics);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseSchoolStatistics(SchoolStatistics object) {
		return null;
	}
